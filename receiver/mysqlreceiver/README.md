...
This receiver supports MySQL version 8.0. MariaDB version 10.11 and later are also supported but features specific to MySQL 8.0 (e.g. the X protocol) will not work.
